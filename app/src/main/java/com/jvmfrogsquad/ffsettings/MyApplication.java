package com.jvmfrogsquad.ffsettings;
...
public class MyApplication extends Application implements ActivityLifecycleCallbacks, DefaultLifecycleObserver {
    ...
    private static final String AD_UNIT_ID = "ca-app-pub-3943668970239539/2696167674";
     ...
     */
    public void loadAd(@NonNull Activity activity, @Nullable OnAdLoadListener listener) {
        // We wrap the loadAd to enforce that other classes only interact with MyApplication
        // class.
        appOpenAdManager.loadAd(activity, listener);
    }
    ...
    private class AppOpenAdManager {
        ...
        private final UserMessagePlatformManager googleMobileAdsConsentManager = UserMessagePlatformManager.getInstance(getApplicationContext());
         ...
         */
        private void loadAd(Context context, OnAdLoadListener listener) {
            ...
            AppOpenAd.load(context, getAdUnitId(), request, new AppOpenAdLoadCallback() {
                /**
                ...
                public void onAdFailedToLoad(LoadAdError loadAdError) {
                    ...
                    // Notify the listener that the ad failed to load.
                    if (listener != null) {
    ...
    /**
     * Interface definition for a callback to be invoked when an app open ad is loaded.
     */
